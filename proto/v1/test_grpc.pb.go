...
func (c *testClient) Test(ctx context.Context, in *TestReq, opts ...grpc.CallOption) (*TestReply, error) {
	out := new(TestReply)
	err := c.cc.Invoke(ctx, "/Test/test", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedTestServer) Test(context.Context, *TestReq) (*TestReply, error) {
